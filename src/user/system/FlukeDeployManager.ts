...
class FlukeDeployManager {
    ...
    initialize() {
        ...
        self.refreshForceSslState()
            ...
            .then(function () {
                ...
                return fs.emptyDir(FlukeDeployConstants.flukedeployRootDirectoryTemp)
            })
            .then(function () {
                return fs.emptyDir(
            ...
            .then(function () {
                return fs.ensureDir(FlukeDeployConstants.flukedeployStaticFilesDir)
            })
            .then(function () {
            ...
            .then(function () {
                const secretFileName = `/run/secrets/${FlukeDeployConstants.flukedeploySaltSecretKey}`
    ...
    updateGoAccessInfo(goAccessInfo: GoAccessInfo) {
        ...
        return Promise.resolve()
            ...
            .then(function () {
                Logger.d(
                    'Updating Load Balancer - FlukeDeployManager.updateGoAccess'
                )
    ...
    enableSsl(emailAddress: string) {
        ...
        return Promise.resolve()
            ...
            .then(function () {
                Logger.d('Updating Load Balancer - FlukeDeployManager.enableSsl')
                return self.loadBalancerManager.rePopulateNginxConfigFile()
            })
    }
    ...
    changeCaptainRootDomain(requestedCustomDomain: string, force: boolean) {
        ...
        return self.domainResolveChecker
            ...
            .then(function () {
                Logger.d(
                    'Updating Load Balancer - FlukeDeployManager.changeCaptainRootDomain'
                )
                return self.loadBalancerManager.rePopulateNginxConfigFile()
            })
    }
    ...
    private static captainManagerInstance: FlukeDeployManager | undefined

    static get(): FlukeDeployManager {
        if (!FlukeDeployManager.captainManagerInstance) {
            FlukeDeployManager.captainManagerInstance = new FlukeDeployManager()
        }
        return FlukeDeployManager.captainManagerInstance
    }
}

export default FlukeDeployManager
